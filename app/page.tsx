...
import { getAllPages, getTrade, TRADE_LABELS, type Trade } from '@/lib/content';
...
const CREW_CELLS = [
  {
    ...
    heading: 'Just me',
    breaks:
      'The phone is the bottleneck. Every quote request arrives while you are holding a hose or a vacuum, and the ones you return two days later have already booked someone else.',
    href: '/cleaning-business-software-online-booking/',
    linkText: 'Software with online booking',
  },
  {
    size: '2 to 4 people',
    heading: '2 to 4 people',
    breaks:
    ...
    linkText: 'Scheduling software compared',
  },
  {
    size: '5 to 10 people',
    heading: '5 to 10 people',
    breaks:
    ...
    linkText: 'Routing software compared',
  },
  {
    ...
    linkText: 'Accounting software compared',
  },
];
...
const TRADE_BLURBS: Record<Trade, string> = {
  cleaning:
    'Residential and commercial cleaning companies, including carpet cleaning. Recurring work, high cancellation rates and crews who rarely sit at a desk.',
  'lawn-care':
  ...
  return (
    <>
      <section className="wrapper hero">
        <span className="eyebrow">Cleaning, lawn care and pest control. One to twenty staff.</span>
      ...
      <section className="wrapper section" aria-labelledby="crew-picker">
        <div className="section-head">
          ...
          <h2 id="crew-picker">Pick the size you are, not the software you think you want</h2>
          <p>
        ...
        <div className="crew-grid">
          {CREW_CELLS.map((cell) => (
            <Link key={cell.heading} href={cell.href} className="crew-cell">
              ...
              <h3>{cell.heading}</h3>
              <p>{cell.breaks}</p>
              <span className="crew-link">{cell.linkText}</span>
            </Link>
          ))}
        </div>
      </section>
      ...
      {TRADE_ORDER.map((trade) => {
        ...
        return (
          <section key={trade} className="wrapper section" id={trade} aria-labelledby={`${trade}-heading`}>
            <div className="section-head">
      ...
      <section className="wrapper section" id="how-we-compare" aria-labelledby="how-we-compare-heading">
        <div className="section-head">
        ...
        <div className="reading">
          <p>
            ...
            software, it is running a phone. So every price in every table here is the lowest tier
            that includes online booking, quoted at one, three and ten users, with per seat costs
            added in rather than hidden in a footnote.
          </p>
          <p>
            ...
            and year its figures were read off the vendor pricing page, in the strip above the
            heading. Where a vendor does not publish a number at all, the table says Not published
            rather than repeating a figure from a review site.
          </p>
          <p>
